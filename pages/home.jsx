            ...
            <section id='skills' ref={skills}>
                ...
                <div className='skills-text flex-right'>
                    <AnimationOnScroll animateOnce delay={500} animateIn="animate__fadeInUp">
                        ...
                        <p>I'm very profficient at multiple front-end frameworks, such as React, Next, Vue, Angular, and React Native, in order of experience. I'm also comfortable with most popular styling and component libraries, such as SASS, Tailwind, MUI, Semantic, etc.</p>
                    </AnimationOnScroll>
                </div>
                <div className='skills-text flex-left'>
                    <AnimationOnScroll animateOnce delay={900} animateIn="animate__fadeInUp">
                        ...
                        <p>Although it's not my main focus right now, I've also gathered quite a lot of experience in back-end languages, such as PHP, Laravel, .NET, and Node. I'm also secently acquainted with a few Sequential Query Languages, like MySQL, MariaDB, and PostgreSQL, integrated through both REST and GraphQL APIs.</p>
                    </AnimationOnScroll>
                </div>
            </section>
